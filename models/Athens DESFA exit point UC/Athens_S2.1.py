...
def experiment_function(H2_selling_price_per_kg, simulation_horizon_number_of_years):
    ...
    #Selling prices data
    H2_sale_price_per_kg = 8#H2_selling_price_per_kg
    ...
    electrolysis_fixed_opex += electrolysis_TSO_cost_per_MW_per_year*(1+tax_on_TSO_fee) #add (if necessary) TSO service charges for transmission, and the corresponding tax
