...
def experiment_function(H2_selling_price_per_kg, simulation_horizon_number_of_years):
    ...
    battery_capex, battery_marginal = input_parameters_data['battery_capex'][0], input_parameters_data['battery_marginal'][0]
    battery_fixed_opex = input_parameters_data['battery_fixed_opex'][0]
    ...
    #Stores
    network.add("Store", name = "Battery", bus="Bus H2_2", e_cyclic=True, e_nom_extendable=True,
                marginal_cost = battery_marginal,
                capital_cost  = battery_capex)
    ...
    battery_fixed_opex_per_year =  model.variables['Store-e_nom'] * battery_fixed_opex
    total_fixed_opex_per_year = electrolyzer_fixed_opex_per_year + battery_fixed_opex_per_year
    ...
    fixed_opex_H2_storage = network.stores.loc['H2 depot', 'e_nom_opt' ] * battery_fixed_opex *simulation_years
    ...
    fixed_opex_H2_storage_yearly = network.stores.loc['H2 depot', 'e_nom_opt' ] * battery_fixed_opex #OK
