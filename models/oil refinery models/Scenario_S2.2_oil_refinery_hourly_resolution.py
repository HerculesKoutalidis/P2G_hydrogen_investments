...
def experiment_function(H2_selling_price_per_kg, simulation_horizon_number_of_years):
    ...
    df = pd.DataFrame()
    data = {'Info': f'hourly resolution, {simulation_years} sim.years, oil refinery UC, S2.2',
    ...
    df = df.T
    save_results_dir =  f'S2.2_oil_refinement_{simulation_years}Y_H2_price_{H2_sale_price_per_kg}_EUR_per_kg'
